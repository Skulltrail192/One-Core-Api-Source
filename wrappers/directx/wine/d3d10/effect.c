...
{
    (ID3D10EffectVariableVtbl *)&d3d10_effect_shader_resource_variable_vtbl,
    &null_local_buffer,
    &null_type
};

//null_shader_resource_variable.u.resource.srv = null_srvs;
...
{
    const struct vkd3d_shader_code dxbc = {data, data_size};
