...
/******************************************************************************
 * CreateBoundaryDescriptorW    (kernelex.@)
 */
HANDLE 
WINAPI 
...
/******************************************************************************
 * CreateBoundaryDescriptorA    (kernelex.@)
 */
HANDLE 
WINAPI 
...
// The only flag is UWP app containers, we don't care. Needs to be in advapi32, and kernel32/kernelex needs to export it.
