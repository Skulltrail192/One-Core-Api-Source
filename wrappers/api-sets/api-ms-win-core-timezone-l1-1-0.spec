@ stdcall EnumDynamicTimeZoneInformation(long ptr) kernelex.EnumDynamicTimeZoneInformation
...
@ stdcall GetDynamicTimeZoneInformationEffectiveYears(ptr ptr ptr) kernelex.GetDynamicTimeZoneInformationEffectiveYears
...
@ stdcall SetDynamicTimeZoneInformation(ptr) kernelex.SetDynamicTimeZoneInformation
...
@ stdcall SystemTimeToTzSpecificLocalTimeEx(ptr ptr ptr) kernel32.SystemTimeToTzSpecificLocalTimeEx
