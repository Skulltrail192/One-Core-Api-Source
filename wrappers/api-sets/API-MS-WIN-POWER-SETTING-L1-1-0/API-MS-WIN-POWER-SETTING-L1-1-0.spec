...
@ stdcall PowerSettingUnregisterNotification(ptr) powrprof.PowerSettingUnregisterNotification
@ stdcall PowerWriteACValueIndex(ptr ptr ptr ptr long) powrprof.PowerWriteACValueIndex
@ stdcall PowerWriteDCValueIndex(ptr ptr ptr ptr long) powrprof.PowerWriteDCValueIndex
